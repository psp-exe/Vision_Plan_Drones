...
def generate_launch_description():
    ...
    world_name = LaunchConfiguration("world_name", default="warehouse.world")
    ...
    # Default to warehouse world for VLM training
    # Use world_name:=playground.world to switch back
